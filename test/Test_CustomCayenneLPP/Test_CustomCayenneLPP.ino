...
void loop(){
  ...
  float humidity = 53.5;            //test value 53,5
  debugSerial.print(F("Humidity: "));
  debugSerial.print(humidity);
  debugSerial.println(F(" %RH."));

  float temperature = 21.7;         //test value 21.7
  debugSerial.print(F("Temperature: "));
  debugSerial.print(temperature);
  debugSerial.println(F(" Degrees."));

  float luminosity = 236;           //test value 236
  ...
  // functions for adding the temperature, humidity and luminosity

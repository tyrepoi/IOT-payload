...
uint8_t CayenneLPP::addByte(uint8_t channel, uint8_t type, float value, uint16_t resolution) {
...
uint8_t CayenneLPP::add2Bytes(uint8_t channel, uint8_t type, float value, uint16_t resolution)  {
    uint16_t valueScaled = value * resolution;
...
uint8_t CayenneLPP::add4Bytes(uint8_t channel, uint8_t type, float value, uint16_t resolution){
    uint32_t valueScaled = value * resolution;
